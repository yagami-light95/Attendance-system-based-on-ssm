...
public class AdminController {
    ...
    public String showSign(Model model, Integer page, String createDate, Integer departmentId) {
        ...
        PagingVO pagingVO = new PagingVO();
        //设置总页数
        pagingVO.setTotalCount(adminService.getReportInfoCount(createDate, departmentId));
        if (page == null || page == 0) {
            pagingVO.setToPageNo(1);
            list = adminService.findReportInfoByPaging(1, createDate, departmentId);
        } else {
            pagingVO.setToPageNo(page);
            list = adminService.findReportInfoByPaging(page, createDate, departmentId);
        }
    ...
    public Map<String, Object> analysis() {
    	Boolean finished = adminService.recostExpense();
    	Map<String, Object> map = new HashMap<String, Object>();
